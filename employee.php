   ...
   <body>
      <div id="app">
         ...
         <div id="main">
                  ...
                  <ul class="navbar-nav d-flex align-items-center navbar-light ms-auto">
                     ...
                     <li class="dropdown">
                        <a href="#" data-bs-toggle="dropdown"
                           ...
                           <?php echo '<img src="data:image/jpg;base64,' . base64_encode($profileImage) . '" alt="" style="width: 32px; height: 32px; border-radius: 50%;">'; ?></div>
               ...
               <section class="section">
                  <div class="row mb-2">
                    <div class="col-xl-4 col-md-12 mb-4">
                      <a href="apply_leave.php" class="card-link">
                        <div class="card">
                          <div class="card-body">
            ...
            <a href="leave_status.php" class="card-link">
              <div class="card">
                <div class="card-body">
                  <div class="d-flex justify-content-between p-md-1">
                    <div class="d-flex flex-row">
                      <div class="align-self-center">
                        <i class="fa fa-calendar-check text-success fa-3x me-4"></i>
                      </div>
                      <div>
                        <h4>Leave Status</h4>
                      </div>
