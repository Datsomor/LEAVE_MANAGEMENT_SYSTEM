...
if (isset($_SESSION['USERNAME'])) {
    ...
    if ($conn->connect_error) {
        ...
        // Fetch director-approved leave applications from the same directorate
        $query = "SELECT * FROM leave_application
                  WHERE  leave_application.STATUS = 'Director Approved'";
        ...
        if ($result) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<td>";
                // You can add more buttons or actions if needed
