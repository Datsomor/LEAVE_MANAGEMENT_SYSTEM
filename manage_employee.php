                  ...
                  <ul class="menu">
                     ...
                     <li class="sidebar-item  has-sub">
                        ...
                        <ul class="submenu ">
                           ...
                           <li>
                              <a href="rejected.php">Not Approve Leaves</a>
                           </li>
                        </ul>
                     </li>
                     <li class="sidebar-item  has-sub">
...
$(document).ready(function() {
    ...
    $('.delete-button').on('click', function() {
        ...
        if (confirm('Are you sure you want to delete this staff?')) {
            // Send AJAX request to delete_staff.php
            $.ajax({
                type: 'POST',
                url: 'delete_staff.php',
                data: { id: staffId },
                success: function(response) {
                    // Handle success (you can update the table or provide feedback)
