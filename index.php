   ...
   <body>
      <div id="app">
         ...
         <div id="main">
               ...
               <section class="section">
                  <div class="row mb-2">
                               <div class="col-xl-4 col-md-12 mb-4">
                                 <div class="card">
                                    <div class="card-body" onclick="window.location.href='manage_employee.php';" style="cursor: pointer;">
                                        <div class="d-flex justify-content-between p-md-1">
                                            <div class="d-flex flex-row">
                                                ...
                                                <div>
                                                    <h4>STAFF</h4>
                                                    <h2 class="h1 mb-0"><?php echo $staffCount ?></h2>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="col-xl-4 col-md-12 mb-4">
            <div class="card">
              <div class="card-body"onclick="window.location.href='all_leave.html';" style="cursor: pointer;">
                <div class="d-flex justify-content-between p-md-1">
                  <div class="d-flex flex-row">
                    <div class="align-self-center">
                    ...
                    <div>
                      <h4>LEAVE</h4>
                    <h2 class="h1 mb-0"><?php echo $leaveCount ?></h2>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="col-xl-4 col-md-12 mb-4">
            <div class="card">
              <div class="card-body"onclick="window.location.href='approve_leave.php';" style="cursor: pointer;">
                <div class="d-flex justify-content-between p-md-1">
                  <div class="d-flex flex-row">
                    <div class="align-self-center">
                    ...
                    <div>
                      <h4>APPROVED</h4>
                    <h2 class="h1 mb-0"><?php echo $approvedCount ?></h2>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="card">
              <div class="card-body"onclick="window.location.href='pending_leave.html';" style="cursor: pointer;">
                <div class="d-flex justify-content-between p-md-1">
                  <div class="d-flex flex-row">
                    <div class="align-self-center">
                    ...
                    <div>
                      <h4>PENDING</h4>
                    <h2 class="h1 mb-0"><?php echo $pendingCount ?></h2>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="card">
              <div class="card-body"onclick="window.location.href='not_approve_leave.html';" style="cursor: pointer;">
                <div class="d-flex justify-content-between p-md-1">
                  <div class="d-flex flex-row">
                    <div class="align-self-center">
                    ...
                    <div>
                      <h4>CANCELLED</h4>
                    <h2 class="h1 mb-0"><?php echo $cancelledCount ?></h2>
                    </div>
                  </div>
                </div>
              </div>
